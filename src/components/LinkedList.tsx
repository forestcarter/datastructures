...
class LinkedList extends Component<IProps, IState> {
    ...
    getFilmName = async (indexNum: number) => {
        ...
        const rawResponse = await fetch("https://api.graphcms.com/simple/v1/swapi", {
			method: "POST",
        ...
        this.setState(prevState => ({
            nodes: [
                ...
                {
                    nodeId: indexNum,
                    filmName: dataResult.data.allFilms[indexNum].title
                }
            ]
        }));
        ...
        return (
            <div>
                ...
                <div className="flexRow">
                    ...
                    <Button
                        disabled={
                            this.state.loading || this.state.nodes.length >= 7
                        }
                        className="addButton"
